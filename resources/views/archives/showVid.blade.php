                ...
                <div class="row mt-4 mb-4">
                    <div class="col-lg-12">
                        <div class="card d-block pt-3 pb-3">
                            <div class="card-body">
                                <h1 class="c-grey pb-5">تفاصيل الفيديوهات</h1>
                                        ...
                                        @foreach ($images as $image)
                                            ...
                                            @if (in_array(strtolower($fileExtension), $imageExtensions))
                                                ...
                                                <div class="col-lg-3 col-md-4 col-sm-6">
                                                    <div
                                                        class="image d-flex mb-3 pe-5 ps-5 w-120 align-items-center pt-3 pb-3 rounded bg-grey">
                                                        <img src="{{ asset('uploads/' . $image) }}" alt="Image"
                                                            width="360" height="360" class="clickable-image"
                                                            data-image="{{ $image }}">
                                                        <!-- زر حذف الصورة -->
                                                        <a style="font-size: 40px"
                                                            onclick="confirmDeleteVideoShow('{{ $Video->id }}', '{{ $image }}')">
                                            ...
                                            @else
                                                ...
                                                <div class="col-lg-3 col-md-4 col-sm-6">
                                                    <div
                                                        class="image  flex-column align-items-center pt-3 pb-3 rounded bg-grey">
                                                        <!-- زر حذف الملف -->
                                                        <a 
                                                            class="d-flex  align-items-center flex-column"
                                                            href="{{ asset('uploads/' . $image) }}"
                                                            target="_blank"> <i data-image="{{ $image }}"
                                                                class="fas fa-file"
                                ...
                                <form id="delete-form-{{ $Video->id }}"
                                    action="{{ route('Videos.delete', $Video->id) }}" method="POST"
                                    style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            ...
                            <a href="{{ route('Videos.Videos') }}" class="btn btn-secondary">العودة</a>
                        </div>
                    </div>
                </div>
                {{-- end Show video --}}
                                ...
                                <form action="{{ route('Videos.storeShow', ['id' => $Video->id]) }}" method="POST"
                                    ...
                                    <div class="row align-items-center">
                                        <div class="form-group col-lg-6 col-md-6 col-sm-12 pt-3 pb-3">
                                            <input class="form-control" type="file" name="selectfileVid[]" multiple>
                                        </div>
