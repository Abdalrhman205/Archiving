            ...
            <div class="main-content-inner">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('documents.store') }}" method="POST" enctype="multipart/form-data" class="t-right">
                                    @csrf
                                    <div class="row">
                                        <div class="form-group col-lg-3 col-md-4 col-sm-12 pt-3 pb-3">
                                            <input class="form-control @error('nameDoc') is-invalid @enderror" type="text" name="nameDoc" placeholder="اسم المستند" value="{{ old('nameDoc') }}">
                                            @error('nameDoc')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="form-group col-lg-3 col-md-4 col-sm-12 pt-3 pb-3">
                                            <select class="form-control @error('conditionDoc') is-invalid @enderror" name="conditionDoc">
                                        ...
                                        <div class="form-group col-lg-3 col-md-4 col-sm-12 pt-3 pb-3">
                                            <select class="form-control @error('sideDoc') is-invalid @enderror" name="sideDoc">
                                        ...
                                        <div class="form-group col-lg-3 col-md-4 col-sm-12 pt-3 pb-3">
                                            <input class="form-control @error('selectfileDoc') is-invalid @enderror" type="file" name="selectfileDoc">
                                            @error('selectfileDoc')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
